using BrightisRendererV2.Models.UI.Events;
using BrightisRendererV2.Models.UI.Events.Exceptions;

namespace BrightisRendererV2.UI.Events;

public class EventBroker
{
    public static readonly EventBroker Instance = new();
